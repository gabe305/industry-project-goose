  ...
  return (
    <div className="footer">
      <div className="footer__top">
        <div className="footer__column footer__discover">
          <h3 className="footer__subheader">DISCOVER YOUR NEAREST STORE</h3>
          <img src={img} alt="inside of store" />
          <p>Experience our Canada Goose retail stores in person</p>
          <div className="footer__find-a-store">
            <p className="footer__find-a-store--text">Find a Store</p>
            <img className="footer__find-a-store--img" src={icon} alt="logo circle" />
          </div>  
        </div>
        <div className="footer__text-columns">
          <div className="footer__column footer__help">
            <h3 className="footer__subheader">HOW CAN WE HELP?</h3>
            <p>Contact Us</p>
            <p>Shop Live</p>
            <p>Delivery</p>
          ...
          <div className="footer__column footer__products">
            <h3 className="footer__subheader">OUR PRODUCTS</h3>
            <p>Craftsmanship</p>
            <p>Customization</p>
            <p>Fusion Fit</p>
            <p>Counterfeit</p>
          ...
          <div className="footer__column footer__more">
            <h3 className="footer__subheader">MORE</h3>
            <p>Locations</p>
            <p>Our History</p>
            <p>Press</p>
        ...
        <div className="footer__column footer__inbox">
          <h3 className="footer__subheader">GET US IN YOUR INBOX</h3>
          <form className="footer__email">
            <div className="footer__form-group">
              <input className="footer__email-input" id="footerEmail" type="text" name="footerEmail" placeholder="Email Address"/>
            </div> 
          </form>
